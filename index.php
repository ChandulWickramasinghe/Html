<?php
	// SQL Tutorial - ChanduWithProgramming.unaux..com
	// Version: 5.1
...
<head>
	...
	<title>SQL Query WebApp by Chandul With Programming</title>
	<style>
		* { margin: 0; padding: 0; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}
		...
		h3{background-color: #D8EB09; color: white; font: 30px Arial, "Helvetica Neue", Helvetica, sans-serif;  font-weight: normal; padding: 30px; box-shadow: 1px 1 1px 1px #50C7C7;}
		...
		textarea { font-size: 30px; padding: 10px; width: 100%; height: 200px; }
		...
		.result-container { height: 480px; background: #aaa; border: 2px solid #aaa; margin: 0 5px; }
...
/* 		select { display: none } */
		select { padding: 3px; }
		option { padding: 3px;}
		.Restore:hover{background-color: #926239;}
		.logout:hover{background-color:#E2F511 ; border-width: 3px; border-radius: 30px;}
		.run:hover{background-color: #E2F511; border-width: 3px; border-radius: 30px;}
		.Restore{background-color: #E2F511; margin: 3px; padding: 3px;}
	</style>
</head>
<body>
	<?php echo $login_form; ?>
	<h3><b>Database</b>: <?php echo $host; ?> > <?php echo $db_name; ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?logout" class="logout">Log Out</a></a> <span class="appname"><b>Chandul With Programmign Sql Web App</b> | <small> Version 5</small></span></h3>
...
// 				$_SESSION['history'] = array_unique($_SESSION['history']);
	...
	<form action="index.php" method="post" class="restore">
		<label for="" class="Restore">Type RESTORE and click Restore Database button to Restore the Database:</label>
